...
//
//             RelationalForeignKeyBuilderExtensions.HasConstraintName((ReferenceCollectionBuilder)entity.HasOne(d => d.Category).WithMany(p => p.Activities)
//                 .HasForeignKey(d => d.CategoryId)
//                 .OnDelete(DeleteBehavior.ClientSetNull), "FK_Activity_Categories");
//
//             RelationalForeignKeyBuilderExtensions.HasConstraintName((ReferenceCollectionBuilder)entity.HasOne(d => d.Package).WithMany(p => p.Activities)
//                 .HasForeignKey(d => d.PackageId)
//                 .OnDelete(DeleteBehavior.ClientSetNull), "FK_Activity_Packages");
//
//             RelationalForeignKeyBuilderExtensions.HasConstraintName((ReferenceCollectionBuilder)entity.HasOne(d => d.Schedule).WithMany(p => p.Activities)
//                 .HasForeignKey(d => d.ScheduleId), "FK_Activity_Calendar");
//         });
//
...
//
//             RelationalForeignKeyBuilderExtensions.HasConstraintName((ReferenceCollectionBuilder)entity.HasOne(d => d.Activity).WithMany(p => p.Calendars)
//                 .HasForeignKey(d => d.ActivityId)
//                 .OnDelete(DeleteBehavior.ClientSetNull), "FK_Calendar_Activity");
//
...
//
//             RelationalForeignKeyBuilderExtensions.HasConstraintName((ReferenceCollectionBuilder)entity.HasOne(d => d.Activity).WithMany(p => p.Contents)
//                 .HasForeignKey(d => d.ActivityId)
//                 .OnDelete(DeleteBehavior.ClientSetNull), "FK_Content_Activity");
//
...
//             entity.Property(e => e.Created).HasColumnType("datetime");
//
//             RelationalForeignKeyBuilderExtensions.HasConstraintName((ReferenceCollectionBuilder)entity.HasOne(d => d.Activity).WithMany(p => p.Performeds)
//                 .HasForeignKey(d => d.ActivityId)
//                 .OnDelete(DeleteBehavior.ClientSetNull), "FK_Performed_Activity");
//
...
//             entity.Property(e => e.Created).HasColumnType("datetime");
//
//             RelationalForeignKeyBuilderExtensions.HasConstraintName((ReferenceCollectionBuilder)entity.HasOne(d => d.Activity).WithMany(p => p.ProfileActivities)
//                 .HasForeignKey(d => d.ActivityId)
//                 .OnDelete(DeleteBehavior.ClientSetNull), "FK_ProfileActivities_Activity");
//
